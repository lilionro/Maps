...
import com.zero.lionro.maps.ui.view.DriveSegmentListAdapter;
...
public class DriveRouteDetailActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        String dur = ToastUtils.getFriendlyTime((int) mDrivePath.getDuration());
        String dis = ToastUtils.getFriendlyLength((int) mDrivePath
                .getDistance());
